...
# Not logged in user is redirected to the login page when attempting to create,
...
def test_author_required(app, client, auth):
    ...
    # Current user doesn't see update link
    assert b'href="/1/update"' not in client.get("/").data

# 404 is returned when the post does not exist.
@pytest.mark.parametrize("path", (
    "/2/update",
    "/2/delete",
))
